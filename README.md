...
To view this React + Redux project with data from the YouTube APIs, clone this repo and install/start the app.

* Clone the repo
    - `create a local folder`
    - `git clone https://github.com/bethlei/YouTube.git`
...
This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) and utilized the following libraries and APIs.
